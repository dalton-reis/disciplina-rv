...
class VuforiaViewController: UIViewController {
    ...
    @objc func returnToMenu() {
        if mTarget == getImageTargetId() {
            performSegue(withIdentifier: "returnSegueIT", sender: nil)
        } else if mTarget == getModelTargetId() {
            performSegue(withIdentifier: "returnSegueMT", sender: nil)
        }
    }
